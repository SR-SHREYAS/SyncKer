...
from app.handlers.skill_handler import SkillHandler
...
def create_skill(
    ...
    return handler.create_skill(payload)
...
def attach_skill_to_me(
    ...
    return handler.attach_skill_to_user(current_user_id, payload)
...
def list_my_skills(
    ...
    return handler.list_user_skills(current_user_id)
